...
class Feed_CPT_Options {
    ...
    public function combine_faceboooooook_token_options() {
        ...
        $this->all_options['combine_facebook_token_options'] = array(
            ...
            'main_options'       => array(
                ...
                array(
                    'input_wrap_class' => 'combine-instagram-access-token-placeholder',
                    'option_type' => '',
                    'label'       => '',
                    'instructional-text' => '',
                    'type'        => '',
                ...
                // Combine Facebook Wrap for Token
                array(
                    'option_type' => '',
    ...
    // leaving off here, need to figure out why the options are not staying saved after going to another tab and coming back
    public function combineeeeeee_token_options() {
