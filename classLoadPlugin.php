...
class classLoadPlugin {
    ...
    public function loadPluginComponents() {
        ...
        $feed_cpt_options = new FeedCPTOptions( $facebook_additional_options, $instagram_additional_options, $twitter_additional_options, $youtube_additional_options );
        ...
        $system_info = new SystemInfo( $settingsFunctions, $feedFunctions, $feedCache );
        new FeedOptionsImportExport( $feedFunctions, $dataProtection, $system_info );
        $setting_options_js = new SettingsOptionsJS();
        $metabox_functions = new MetaboxFunctions( $feedFunctions, $feed_cpt_options->get_all_options(true), $settingsFunctions, $optionsFunctions, FEED_THEM_SOCIAL_OPTION_ARRAY_NAME, $dataProtection );
        $accessOptions = new AccessTokenOptions( $feedFunctions, $feed_cpt_options, $metabox_functions, $dataProtection, $optionsFunctions );
        new FeedsCPT( $settingsFunctions, $feedFunctions, $feed_cpt_options, $setting_options_js, $metabox_functions, $accessOptions, $optionsFunctions );
