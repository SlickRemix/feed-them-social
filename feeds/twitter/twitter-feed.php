...
class FTS_Twitter_Feed extends feed_them_social_functions
{
    ...
    function fts_twitter_description($post_data) {
        ...
        $replace = array(' <a href="${0}" target="_blank" rel="nofollow">${0}</a>', ' <a href="${0}" target="_blank" rel="nofollow">${0}</a>', ' <a href="https://twitter.com/$1" target="_blank" rel="nofollow">@$1</a>', ' <a href="https://twitter.com/search?q=%23$2&src=hash" target="_blank" rel="nofollow">#$1</a>');
                ...
                <?php } ?>
                    ...
                    ?>
                                ...
                                <div class="fts-twitter-reply-wrap-left"><?php
                                    // twitter permalink per post
                                    print $this->fts_twitter_permalink($post_data); ?><div class="fts-tweet-others-right"><?php print $this->fts_twitter_retweet($post_data) ?><?php print $this->fts_twitter_favorite($post_data) ?></div>
