<?php
/**
 * Feed Them Social - Access Token Options
 *
...
class Access_Token_Options {
	 ...
	 * @since 2.7.1
	 */
	public function set_new_access_tokens( $feed_type ) {
		// Set New Access Tokens!
	 ...
	 * @since 1.9.6
	 */
	public function twitter_access_token_options( $feed_type ) {

		// Check if new tokens have been returned.
		$this->set_new_access_tokens( $feed_type );
