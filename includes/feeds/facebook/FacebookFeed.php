...
class FacebookFeed {
    ...
    public function displayFacebook( $feed_post_id ) {
        ...
        if ( ! $this->feedFunctions->isExtensionActive( 'feed_them_social_facebook_reviews' ) && ! $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && ! $this->feedFunctions->isExtensionActive( 'feed_them_social_combined_streams' ) && $saved_feed_options['facebook_page_post_count'] > '6' ) {
            $saved_feed_options['facebook_page_post_count'] = '6';
        }
        ...
        $fts_count_ids = $this->feedFunctions->isExtensionActive( 'feed_them_social_combined_streams' ) ? substr_count( $saved_feed_options['fts_facebook_custom_api_token_user_id'], ',' ) : '';
        ...
        if ( $this->feedFunctions->isExtensionActive( 'feed_them_social_facebook_reviews' ) ) {
        ...
        if ( ! isset( $_GET['load_more_ajaxing'] ) ) {
            ...
            $_REQUEST['fts_dynamic_name'] = sanitize_key( $this->feedFunctions->getRandomString( 10 ) . '_' . $saved_feed_options['facebook_page_feed_type'] );
            // Create Dynamic Class Name.

            $fts_dynamic_class_name =  $this->feedFunctions->getFeedDynamicClassName();
            // SOCIAL BUTTON.
            ...
            if ( $this->feedFunctions->isExtensionActive( 'feed_them_social_facebook_reviews' ) && isset( $saved_feed_options['reviews_overall_rating_show'] ) && $saved_feed_options['reviews_overall_rating_show'] === 'yes' ) {
...
style="margin:' . ( isset( $saved_feed_options['slider_margin'] ) && $saved_feed_options['slider_margin'] !== '' ? esc_attr( $saved_feed_options['slider_margin'] ) : 'auto' ) . ';' . ( isset( $fts_cycle_type ) && $fts_cycle_type === 'carousel' ? 'width:100%; max-width:100%; overflow:hidden;height:' . esc_attr( $saved_feed_options['facebook_image_height'] ) . '!important;' : 'overflow:hidden; height:' . esc_attr( $saved_feed_options['facebook_image_height'] ) . '; max-width:' . ( isset( $saved_feed_options['facebook_image_width'] ) && $saved_feed_options['facebook_image_width'] !== '' ? esc_attr( $saved_feed_options['facebook_image_width'] ) : 'auto' ) ) . ';" data-cycle-caption="#fts-custom-caption-' . esc_attr( $fts_dynamic_class_name ) . '" data-cycle-caption-template="{{slideNum}} / {{slideCount}}" data-cycle-pager=".fts-custom-pager-' . esc_attr( $fts_dynamic_class_name ) . '" data-cycle-pause-on-hover="true" data-cycle-prev=".fts-prevControl-' . esc_attr( $fts_dynamic_class_name ) . '" data-cycle-next=".fts-nextControl-' . esc_attr( $fts_dynamic_class_name ) . '" data-cycle-timeout="' . ( ! empty( $saved_feed_options['slider_timeout'] ) ? esc_attr( $saved_feed_options['slider_timeout'] ) : '0' ) . '" data-cycle-manual-speed="' . ( ! empty( $saved_feed_options['slider_speed'] ) ? esc_attr( $saved_feed_options['slider_speed'] ) : '400' ) . '" data-cycle-auto-height="false" data-cycle-slides="> div" data-cycle-fx="' . ( ! empty( $saved_feed_options['scrollhorz_or_carousel']) ? esc_attr( $saved_feed_options['scrollhorz_or_carousel']) : '' ) . '" data-cycle-carousel-visible=' . ( ! empty( $saved_feed_options['slides_visible'] ) ? esc_attr( $saved_feed_options['slides_visible'] ) : '4' ) . ' data-cycle-swipe=true data-cycle-swipe-fx=' . ( ! empty( $saved_feed_options['scrollhorz_or_carousel']) ? esc_attr( $saved_feed_options['scrollhorz_or_carousel']) : '' ) . '>';
                ...
                if ( $saved_feed_options['facebook_page_feed_type'] === 'page' && isset( $saved_feed_options['facebook_grid'] ) && $saved_feed_options['facebook_grid'] === 'yes' ||
                    ...
                    echo '<div class="fts-slicker-facebook-posts masonry js-masonry ' . esc_attr( $fts_mashup_media_top . $fts_mashup_show_name . $fts_mashup_show_date . $fts_mashup_show_thumbnail ) . ( $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && $saved_feed_options['facebook_popup'] === 'yes' ? 'popup-gallery-fb-posts ' : '' ) . ( $saved_feed_options['facebook_page_feed_type'] === 'reviews' ? 'fts-reviews-feed ' : '' ) . esc_attr( $fts_dynamic_class_name ) . ' " style="margin:auto;" data-masonry-options=\'{ "isFitWidth": ' . ( $saved_feed_options['facebook_container_position'] === 'no' ? 'false' : 'true' ) . ',"transitionDuration": 0 }\'>';
                }
            } else {
                ...
                echo '<div class="fts-jal-fb-group-display fts-simple-fb-wrapper ' . esc_attr( $fts_mashup_media_top . $fts_mashup_show_name . $fts_mashup_show_date . $fts_mashup_show_thumbnail ) . ( $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && isset( $saved_feed_options['facebook_popup']  ) && $saved_feed_options['facebook_popup'] === 'yes' ? ' popup-gallery-fb-posts ' : '' ) . ( $saved_feed_options['facebook_page_feed_type'] === 'reviews' ? 'fts-reviews-feed ' : '' ) . esc_attr( $fts_dynamic_class_name ) . ( !empty($facebook_page_height) && $facebook_page_height !== 'auto' ? ' fts-fb-scrollable" style="' . esc_attr( $facebook_page_height ) . '"' : '"' ) . '>';
            }
        } //End ajaxing Check
    ...
    public function getFacebookFeedResponse( $saved_feed_options, $fb_cache_name, $language ) {
        ...
        if ( $this->feedCache->ftsCheckFeedCacheExists( $fb_cache_name ) !== false && ! isset( $_GET['load_more_ajaxing'] ) ) {

            // YO!
            // echo 'Cache Should Be Printing out here.<br/>';
            // echo $fb_cache_name;
            // print_r( $this->feedCache->ftsGetFeedCache( $fb_cache_name ) );

            $response = $this->feedCache->ftsGetFeedCache( $fb_cache_name );
        } else {
            ...
            $response = $this->feedFunctions->ftsGetFeedJson( $mulit_data );
            ...
            if ( ! isset( $_GET['load_more_ajaxing'] ) ) {
                ...
                $fts_error_check_complete = $fts_error_check->facebookErrorCheck( $saved_feed_options, $feed_data );
                ...
                if ( \is_array( $fts_error_check_complete ) && $fts_error_check_complete[0] === true ) {
                    ...
                    if ( $this->feedCache->ftsCheckFeedCacheExists( $fb_cache_name, true ) === true ) {
                        ...
                        return $this->feedCache->ftsGetFeedCache( $fb_cache_name, true );
                    }
            ...
            if ( ! empty( $response['feed_data'] ) ) {
                ...
                $this->feedCache->ftsCreateFeedCache( $fb_cache_name, $response );
    ...
    public function getPostInfo( $feed_data, $saved_feed_options, $language, $fb_cache_name ) {
        ...
        if ( $this->feedCache->ftsCheckFeedCacheExists( $fb_post_data_cache ) && ! isset( $_GET['load_more_ajaxing'] ) ) {
            $response_post_array = $this->feedCache->ftsGetFeedCache( $fb_post_data_cache );
        } else {
            ...
            // Response.
            $response_post_array = $this->feedFunctions->ftsGetFeedJson( $fb_post_array );
            // Make sure it's not ajaxing.
            if ( ! isset( $_GET['load_more_ajaxing'] ) ) {
                // Create Cache.
                $this->feedCache->ftsCreateFeedCache( $fb_post_data_cache, $response_post_array );
            }
        }
    ...
    public function getEventPostInfo( $feed_data, $saved_feed_options, $language ) {
        ...
        if ( $this->feedCache->ftsCheckFeedCacheExists( $fb_event_post_data_cache ) !== false && ! isset( $_GET['load_more_ajaxing'] ) ) {
            $response_event_post_array = $this->feedCache->ftsGetFeedCache( $fb_event_post_data_cache );
        } else {
            // Single Events Array.
            ...
            $response_event_post_array = $this->feedFunctions->ftsGetFeedJson( $fb_single_events_array );
            // Create Cache.
            $this->feedCache->ftsCreateFeedCache( $fb_event_post_data_cache, $response_event_post_array );
            ...
            if ( $share_loc === $fb_show_follow_btn_where && isset( $fb_show_follow_btn ) && $fb_show_follow_btn === 'no' ) {
                ...
                switch ( $fb_show_follow_btn_where ) {
                    case 'above_title':
                        ...
                        $this->feedFunctions->socialFollowButton( 'facebook', $saved_feed_options['fts_facebook_custom_api_token_user_id'], $saved_feed_options );
                        echo '</div>';
                        break;
                    // Top Below Title.
                    case 'below_title':
    ...
    public function ftsFacebookLoadmore( $feed_post_id, $feed_data, $facebook_post_type, $saved_feed_options ) {
        ...
        if ( ( isset( $saved_feed_options['facebook_load_more_style'] ) && $saved_feed_options['facebook_load_more_style'] === 'button' && $saved_feed_options['facebook_load_more'] === 'yes' || isset( $saved_feed_options['facebook_load_more_style'] ) && $saved_feed_options['facebook_load_more_style'] === 'autoscroll') && ( $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && $saved_feed_options['facebook_page_feed_type'] !== 'reviews' || $this->feedFunctions->isExtensionActive( 'feed_them_social_facebook_reviews' ) && $saved_feed_options['facebook_page_feed_type'] === 'reviews') ) {
                        ...
                        jQuery("#loadMore_<?php echo esc_js( $fts_dynamic_name ); ?>").off().click(function () {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    <?php if ( $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && isset( $saved_feed_options['facebook_popup'] ) && 'yes' === $saved_feed_options['facebook_popup'] ) { ?>
            ...
            if ( ! isset( $_GET['load_more_ajaxing'] ) ) {
                ...
                if ( $this->feedFunctions->isExtensionActive( 'feed_them_social_premium' ) && $saved_feed_options['facebook_page_feed_type'] === 'page' && $saved_feed_options['facebook_load_more_style'] === 'autoscroll' ||
                    $this->feedFunctions->isExtensionActive( 'feed_them_social_facebook_reviews' ) && $saved_feed_options['facebook_page_feed_type'] === 'reviews' && $saved_feed_options['facebook_load_more_style'] === 'autoscroll' ) {
