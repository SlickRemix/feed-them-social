...
= Version 2.8.8 Thursday, September 17th, 2020 =
  ...
  * FIX: FACEBOOK OPTOINS PAGE: manage_pages permission is depreciatted in favor of pages_show_list. This is required when going through the login flow allowing you to choose the facebok business pages you are an admin of that you want to get an access token for.
